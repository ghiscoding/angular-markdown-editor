angular.module("angular-markdown-editor", []).directive("markdownEditor", [
    "$rootScope",
    function($rootScope) {
        return {
            restrict: "A",
            ...
            link: function(scope, element, attrs, ngModel) {
                ...
                var additionalButtons =
                    scope.buttonsFactory != null ? scope.buttonsFactory() : [];
                ...
                if (!element.hasClass("processed")) {
                    ...
                    var markdownOptions = {
                        ...
                        onShow: function(e) {
                            ...
                            $rootScope.markdownEditorObjects =
                                $rootScope.markdownEditorObjects || {};
                    ...
                    if (element.markdown === undefined) {
                        element.data(
                            "markdown",
                            (data = new $.fn.markdown.Constructor(
                                element[0],
                                markdownOptions
                            ))
                        );
